...
class UsersController extends Controller
{
    ...
    public function viewUsersCharts(){
      ...
      $two_months_ago_users = User::whereYear('created_at', Carbon::now()->year)->whereMonth('created_at', Carbon::now()->subMonth(2))->count();

      return view('admin.users.view_users_charts')->with(compact('current_month_users', 'last_month_users', 'two_months_ago_users'));
    }
