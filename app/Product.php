...
class Product extends Model
{
    ...
    public static function getCurrencyRates($price){
        ...
        foreach($getCurrencies as $currency){
            ...
            else if($currency->currency_code == "BAM"){
                $BAM_Rate = round($price * $currency->exchange_rate,2);
            }

        }
        $currenciesArr = array('USD_Rate'=>$USD_Rate,'GBP_Rate'=>$GBP_Rate,'BAM_Rate'=>$BAM_Rate);
