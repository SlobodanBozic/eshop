...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Admins/Sub-Admins</a> <a href="#" class="current">Admins/Sub-Admins</a> </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">{{ $admin->updated_at }}</td>
                  <td class="center">
                    <a class="btn btn-primary btn-mini" href="{{ url('/admin/edit-admin/'.$admin->id)}}">Edit</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
