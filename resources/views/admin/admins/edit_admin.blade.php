...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Admins / Sub-Admins</a>
      <a href="#" class="current">Edit Admin / Sub-Admins</a> </div>
            ...
            <form class="form-horizontal" method="post" action="{{ url('admin/edit-admin/'.$adminDetails->id) }}" name="edit_admin" id="edit_admin" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group" id="access">
                ...
                <div class="controls">
                  ...
                  <input type="checkbox" name="categories_edit_access" id="categories_edit_access" value="1" @if($adminDetails->categories_edit_access == '1') checked @endif>&nbsp;View & Edit Categories
                  <input type="checkbox" name="categories_full_access" id="categories_full_access" value="1" @if($adminDetails->categories_full_access == '1') checked @endif>&nbsp;View,Edit & Delete Categories
