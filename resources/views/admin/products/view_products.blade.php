...
<div id="content">
  ...
  <a class="btn btn-primary btn-mini" href="{{ url('/admin/export-products')}}">Export Products in Excel</a>
  </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">EURO {{ $product->price }}</td>
                  <td class="center">EURO {{ $product->list_price }}</td>
                  <td class="center">
