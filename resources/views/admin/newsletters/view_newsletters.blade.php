...
<div id="content">
  ...
  <a class="btn btn-primary btn-mini" href="{{ url('/admin/export-newsletter-emails')}}">Export Newsletters in Excel</a>
  </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <a href="{{ url('admin/delete-newsletter-email/'.$newsletter->id) }}">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
