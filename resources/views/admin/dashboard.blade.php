  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly"> <a href="{{ url('/admin/view-products') }}"> <i class="icon-inbox"></i><span class="label label-success">10</span> Products </a> </li>
        @endif
        @if(Session::get('adminDetails')['orders_access'] == 1)
        <li class="bg_ly"> <a href="{{ url('/admin/view-orders') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Orders </a> </li>
        @endif
        @if(Session::get('adminDetails')['users_access'] == 1)
        <li class="bg_ly"> <a href="{{ url('/admin/view-users') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Users </a> </li>
        @endif
