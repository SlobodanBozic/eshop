...
$two_months_ago = date('M', strtotime("-2 months"));


$dataPoints = array(
		array("y" => $two_months_ago_users, "label" => $two_months_ago),
...
<div id="content">
  ...
  <a class="btn btn-primary btn-mini" href="{{ url('/admin/export-users')}}">Export Users in Excel</a>
  </div>
