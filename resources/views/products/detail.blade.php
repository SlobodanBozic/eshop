						...
						<div class="col-sm-7">
							<form name="addtoCartForm" id="addtoCartForm" action="{{ url('add-cart') }}" method="post">{{ csrf_field() }}
								...
								<div class="product-information"><!--/product-information-->
									...
									<div>&nbsp;</div>
									<img src="/images/frontend_images/home/new.jpg" class="newarrival" alt="" />
									...
									@endif
									@if(!empty($productDetails->product_owner))
										<p>Product Owner: {{ $productDetails->product_owner }}</p>
									@endif
									<p>
									...
									<span>
										...
										<span id="getPrice">
											...
											<h2>
												BAM {{ $getCurrencyRates['BAM_Rate'] }}<br>
										...
										@if($total_stock>0)
											<button type="submit" class="btn btn-fefault cart" id="cartButton" name="cartButton" value="Shoping Cart">
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="material" >
								<div class="col-sm-12">
									<p><?php echo nl2br($productDetails->material); ?></p>
								</div>
							</div>
