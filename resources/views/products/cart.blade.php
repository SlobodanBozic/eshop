						...
						@foreach($userCart as $cart)
							<tr>
								...
								<td class="cart_price">
									...
									<?php $product_price = Product::getProductPrice($cart->product_id, $cart->size); ?> {{-- Secure Cart Pages --}}

									<p>KM {{ $product_price }}</p>
								</td>
								...
								<td class="cart_total">
									<p class="cart_total_price">KM {{ $product_price * $cart->quantity }}</p>
								</td>
					...
					<ul>
						@if(!empty(Session::get('CouponAmount')))
							...
							<li>Grand Total <span class="btn-secondary" data-toggle="tooltip" data-html="true" title="
								...
								BAM {{ $getCurrencyRates['BAM_Rate'] }}
								">KM <?php echo $total_amount; ?></span></li>
						@else
							...
							<li>Grand Total <span class="btn-secondary" data-toggle="tooltip" data-html="true" title="
								...
								GBP {{ $getCurrencyRates['GBP_Rate'] }}<br>
								BAM {{ $getCurrencyRates['BAM_Rate'] }}
								">EURO <?php echo $total_amount; ?></span></li>
						@endif
					</ul>
