...
// Check and Add Subscribe Email
Route::post('/check-and-add-subscriber_email','NewsletterContoroller@checkSubscriber');
...
Route::group(['middleware' => ['adminlogin']], function () {
  ...
  Route::get('/admin/view-newsletter-subscribers','NewsletterContoroller@viewNewsletterSubscribers');


// Update Status of Newsletter Subscribe
Route::get('/admin/update-newsletter-status/{id}/{status}','NewsletterContoroller@updateNewsletterStatus');

// Delete Newsletter Email
Route::get('admin/delete-newsletter-email/{id}','NewsletterContoroller@deleteNewsletterEmail');

// Export Newsletter Emails
Route::get('/admin/export-newsletter-emails', 'NewsletterContoroller@exportNewsletterEmails');
